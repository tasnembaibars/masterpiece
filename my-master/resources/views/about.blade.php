...
<div class="thumb">
<img class="img-fluid" src="../uploads/demo/property/property-2.jpg">
<div class="overylay">
...
<div class="team_member">
<div class="thumb">
<img class="img-fluid" src="../uploads/demo/property/property-3.jpg">
<div class="overylay">
<ul class="social_icon">
<li class="list-inline-item"><a href="#"><i class="fa fa-facebook"></i></a></li>
<li class="list-inline-item"><a href="#"><i class="fa fa-twitter"></i></a></li>
...
<div class="team_member">
<div class="thumb">
<img class="img-fluid" src="../uploads/demo/property/property-4.jpg">
<div class="overylay">
<ul class="social_icon">
<li class="list-inline-item"><a href="#"><i class="fa fa-facebook"></i></a></li>
<li class="list-inline-item"><a href="#"><i class="fa fa-twitter"></i></a></li>
...
<div class="team_member">
<div class="thumb">
<img class="img-fluid" src="../uploads/demo/property/property-5.jpg">
<div class="overylay">
<ul class="social_icon">
<li class="list-inline-item"><a href="#"><i class="fa fa-facebook"></i></a></li>
<li class="list-inline-item"><a href="#"><i class="fa fa-twitter"></i></a></li>
...
<img class="img-fluid" src="../uploads/demo/property/property-6.jpg">
</div>
</div>
<div class="col-sm-6 col-md-4 col-lg">
 <div class="our_partner">
<img class="img-fluid" src="../uploads/demo/property/property-7.jpg">
</div>
</div>
<div class="col-sm-6 col-md-4 col-lg">
<div class="our_partner">
<img class="img-fluid" src="../uploads/demo/property/property-8.jpg">
</div>
</div>
<div class="col-sm-6 col-md-4 col-lg">
<div class="our_partner">
