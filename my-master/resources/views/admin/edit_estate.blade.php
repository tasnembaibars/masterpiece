                      ...
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            ...
                            <select class="form-control form-control-lg @error('category_id') is-invalid @enderror" id="exampleFormControlSelect2" name="category_id"  required value='{{$estate->category_id}}'>
                           @foreach ($categories as $category)
                          <option disabled selected hidden > {{$category->category_name}}</option>
                            
                              <option value="{{$estate->category_id}}">{{$category->category_name}} </option>
                              @endforeach
                            </select>
