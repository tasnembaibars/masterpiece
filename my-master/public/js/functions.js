...
{args=configs;}
args.buttons={confirm:{label:'<i class="fa fa-check"></i> '+i18n.confirm,},cancel:{label:'<i class="fa fa-times"></i> '+i18n.cancel,}};args.centerVertical=true;bootbox.confirm(args);}};function changeFilterProperty(e){var url=$(e).find(":selected").data('url');window.location.href=url;}