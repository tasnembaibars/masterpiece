          ...
          <div class="card-body">
            ...
            <form class="form-sample" method="post" action="/add_estates" enctype="multipart/form-data">
                ...
                <div class="col-md-6">
                  <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                      ...
                      <select class="form-control form-control-lg" id="exampleFormControlSelect2" name="agency_id" required>
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group row">
                    <label class="col-sm-3 col-form-label">Owner name : <span style="color:#ff0000">*</span></label>
                    <div class="col-sm-9">
                ...
                <div class="col-md-6">
                  <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                      <input type="email" class="form-control" name="oEmail" placeholder="Owner Email"/>
                    </div>
                  </div>
                </div>
              </div>
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group row">
                    <label class="col-sm-3 col-form-label">Owner phone : <span style="color:#ff0000">*</span></label>
                    <div class="col-sm-9">
                      <input type="text" class="form-control" name="owner_phone" placeholder="Owner phone number" required/>
                    </div>
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-group row">
                    <label class="col-sm-3 col-form-label">General address:</label>
                    <div class="col-sm-9">
                      <input type="text" class="form-control" name="oAddress" placeholder="Owner Address"/>
                    </div>
                  </div>
                </div>
              </div>
