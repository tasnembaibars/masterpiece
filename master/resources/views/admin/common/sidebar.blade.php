    ...
    <ul class="nav">
      ...
      {{-- <li class="nav-item">
        ...
        <div class="collapse" id="form-elements">
          <ul class="nav flex-column sub-menu">
            <li class="nav-item"><a class="nav-link" href="/basic">Basic Elements</a></li>
          </ul>
        </div>
      </li> --}}
      <li class="nav-item">
      ...
      <li class="nav-item">
        ...
        <div class="collapse" id="charts"> --}}
          <ul class="nav flex-column sub-menu">
            <li class="nav-item"> <a class="nav-link" href="/add">Add category</a></li>
          </ul>
        </div>
      </li>
{{-- agencies --}}
<li class="nav-item">
  ...
  <div class="collapse" id="charts"> --}}
    <ul class="nav flex-column sub-menu">
      <li class="nav-item"> <a class="nav-link" href="/add_agency">Add Agency</a></li>
    </ul>
  </div>
</li>
...
{{-- end agencies --}}
      ...
      <li class="nav-item">
        ...
        <div class="collapse" id="error">
          <ul class="nav flex-column sub-menu">
            <li class="nav-item"> <a class="nav-link" href="/estates">Estates</a></li>
          </ul>
        {{-- </div>
        <div class="collapse" id="charts"> --}}
          <ul class="nav flex-column sub-menu">
            <li class="nav-item"> <a class="nav-link" href="/add_estates">Add Estates</a></li>
          </ul>
        </div>
      </li>
      {{-- endstates --}}
      ...
      <li class="nav-item">
        ...
        <div class="collapse" id="tables">
          <ul class="nav flex-column sub-menu">
            <li class="nav-item"> <a class="nav-link" href="/inbox">Admin Inbox</a></li>
          </ul>
        </div>
      </li>
      {{-- <li class="nav-item">
        ...
        <div class="collapse" id="icons">
          <ul class="nav flex-column sub-menu">
            <li class="nav-item"> <a class="nav-link" href="/property2">Properities</a></li>
          </ul>
        </div>
      </li> --}}
      {{-- <li class="nav-item">
