...
<section class="listing-title-area mt-2">
    ...
    <div class="row mb30">
        <div class="col-lg-12">
            ...
            <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="https://findhouse.bookingcore.org/">Estates</a></li>
            <li class="breadcrumb-item active text-thm" aria-current="page">show estate</li>
            </ol>
    ...
    <h4>{{$estate->address1}},{{$estate->address2}},{{$estate->city}}</h4>
    </div>
    </div>
    ...
    <div class="row">
    <div class="col-lg-12">
    <div class="spls_style_two mb30-520" style="height: 70px">
    <a class="popup-img" href=""><img class="img-fluid w100" src="../{{$estate->image2}}" alt="1.jpg" > </a>
    </div>
    </div>
    </div>
    </div>
    ...
    <div class="spls_style_two mb30" style="height: 10px">
    <a class="popup-img" href="https://findhouse.bookingcore.org/uploads/demo/property/gallery/property-gallery-2.jpg"  ><img class="img-fluid w100" src="../{{$estate->image2}}" alt="2.jpg"></a>
    </div>
    </div>
    <div class="col-sm-6 col-lg-6">
    <div class="spls_style_two mb30">
    <a class="popup-img" href="https://findhouse.bookingcore.org/uploads/demo/property/gallery/property-gallery-3.jpg"><img class="img-fluid w100" src="../{{$estate->image3}}" alt="2.jpg"></a>
    </div>
    </div>
    <div class="col-sm-6 col-lg-6">
    <div class="spls_style_two mb30">
    <a class="popup-img" href="https://findhouse.bookingcore.org/uploads/demo/property/gallery/property-gallery-4.jpg"><img class="img-fluid w100" src="../{{$estate->image1}}" alt="2.jpg"></a>
    </div>
    </div>
    <div class="col-sm-6 col-lg-6">
    <div class="spls_style_two mb30">
    ...
    <div class="row">
    <div class="col-lg-12">
    <div class="listing_single_ 2 mt30-767 mb30-767">
...
@enderror
    ...
    @else
    <div class="form-group">
        <textarea class="form-control @error('review') is-invalid @enderror" name="review" rows="12" placeholder="you need to login first"></textarea>
        </div>
        <input type="hidden" name="estate_id" value="{{$estate->id}}">
    ...
    <img class="mr-3" src="../uploads/demo/general/home.jpg" alt="System Admin">
    </a>
    <div class="media-body">
    <h5 class="mt-0 mb0">Estate Owner Info :</h5>
    <small>The details below are for the person who posted the estate.</small>
    {{-- <p class="mb0">Owner Name</p>
    ...
    <p class="mb0">Owner Name :</p> <span>{{$estate->owner_name}}</span>
    <br/>
    <br/>
    <p class="mb0">Owner Email :</p> <span>{{$estate->oEmail}}</span>
    <br/>
    <br/>
    <p class="mb0">Owner Phone :</p> <span>{{$estate->owner_phone}}</span>
    <br/>
    <br/>
    <p class="mb0">Owner Address :</p> <span>{{$estate->oAddress}}</span>
...
{{-- 
    ...
    <h4 class="title">Featured Agency</h4>
    ...
    <img class="img-whp" src="/image/{{$agency->image}}" >
    <div class="thmb_cntnt">
    <ul class="tag mb0">
    <li class="list-inline-item"><a>{{$agency->agency_name}}</a></li>
